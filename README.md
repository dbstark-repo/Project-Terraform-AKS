...
A simple demonstration on creation of resources using terraform for two environments - dev and stage.

When running locally, the spn created in the bootstrap stage can be used to authenticate terraform in Azure
